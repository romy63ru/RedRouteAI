...
using RedRouteAI.Infrastructure.Data.Interceptors;
...
public static class DependencyInjection
{
    ...
    {
        var connectionString = builder.Configuration.GetConnectionString("RedRouteAIDb");
        Guard.Against.Null(connectionString, message: "Connection string 'RedRouteAIDb' not found.");
